...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.mipmap.onepiece, "One Piece", "One Piece"));
        items.add(new ItemsList(R.mipmap.akame, "Akame Ga Kill ", "Akame ga kill "));
        items.add(new ItemsList(R.mipmap.days, "91 Days", "91 Days"));
        items.add(new ItemsList(R.mipmap.sword, "Sword Art Online", "Sword Art Online"));
        items.add(new ItemsList(R.mipmap.xx, "Darling In the Franxx", "Darling In the Franxx"));
